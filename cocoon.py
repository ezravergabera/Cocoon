...
class Lexer:
    ...
    def make_identifier(self):
        ...
        while (
            self.current_char != None
            and self.current_char in ALPHABET + DIGITS + WHITESPACES + "_" + UNTRACKED
        ):
            if self.current_char in WHITESPACES:
                break
    ...
    def make_operator(self):
        ...
        while (
            self.current_char != None and self.current_char in OPERATORS + WHITESPACES
        ):
            check = self.check()
            if check != None:
    ...
    def make_number(self):
        ...
        isIdentifier = False
        pos_start = self.pos.copy()
        # checks if current char in digits, alphabet, whitespaces
        while (
            self.current_char != None
            and self.current_char in DIGITS + ALPHABET + WHITESPACES + "." + UNTRACKED
        ):
            check = self.check()
            if check != None:
    ...
    def make_string(self):
        ...
        while (
            self.current_char != None
            and self.current_char in ALPHABET + WHITESPACES + '"'
        ):
